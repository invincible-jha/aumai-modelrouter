# Agent Instructions for Modelrouter

## Project Context
Modelrouter is an open source Intelligent routing of LLM requests across providers.

## Repository Layout
- `src/aumai_modelrouter/` — package source
